...
--
-- Host: localhost
-- Generation Time: Jan 11, 2024 at 11:10 AM
...
('l_10', 's_22', '2023/08/18'),
('l_10', 's_23', '2023/03/22'),
('l_10', 's_26', '2023/06/07'),
('l_10', 's_29', '2023/10/16'),
...
('l_5', 's_39', '2023/01/29'),
('l_51', 's_1', '2024/01/11'),
('l_51', 's_22', '2024/01/11'),
('l_51', 's_25', '2024/01/11'),
('l_51', 's_5', '2024/01/11'),
('l_51', 's_61', '2024/01/11'),
('l_51', 's_65', '2024/01/11'),
('l_51', 's_9', '2024/01/11'),
('l_6', 's_111', '2023/08/02'),
('l_6', 's_16', '2023/03/16'),
('l_6', 's_71', '2023/10/11'),
('l_6', 's_93', '2023/05/24'),
...
('l_8', 's_107', '2023/04/19'),
('l_8', 's_109', '2023/08/30'),
('l_8', 's_11', '2023/09/23'),
('l_8', 's_111', '2023/05/03'),
...
('l_8', 's_99', '2023/07/26'),
('l_9', 's_1', '2023/10/06'),
('l_9', 's_100', '2023/12/21'),
('l_9', 's_102', '2023/12/14'),
('l_9', 's_107', '2023/04/17'),
('l_9', 's_111', '2023/10/31'),
